...
// Must match Plonky2's GoldilocksField::MULTIPLICATIVE_GROUP_GENERATOR.
// InternetMaximalism/polygon-plonky2 uses 14293326489335486720 (not 7 as in upstream).
...
// Must match Plonky2's GoldilocksField::POWER_OF_TWO_GENERATOR.

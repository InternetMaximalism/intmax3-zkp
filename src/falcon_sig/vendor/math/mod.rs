...
// VENDOR EDIT (type adaptation only): the host crate's `rand` is 0.8; upstream targets rand 0.10,
// which this crate re-exports under the `rand010` alias. No functional change.
use rand010::Rng;

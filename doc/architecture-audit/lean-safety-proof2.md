...
> [the 2026-09-06 alignment](../audit/lean-current-safety.md). Abstract close availability does
> not prove latest signed-head kit availability. Current pinned close needs no fresh channel signature.

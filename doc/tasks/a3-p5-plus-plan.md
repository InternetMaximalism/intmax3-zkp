...
母艦: `doc/tasks/a3-close-lifecycle-spec.md`(承認済み全スコープ)、`doc/tasks/a3-impl-todo.md`(進捗)。
前提: P1–P4 完成(P4 は `doc/tasks/a3-p4-withdraw-handoff.md` の `withdraw` で締め)。
...
- `doc/tasks/a3-close-lifecycle-followup.md` を closed に。
- `doc/tasks/a3-impl-todo.md` 全チェック。

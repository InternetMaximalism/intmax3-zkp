...
///      reads contracts/test/data/{close_*_mle_config.json,cli_reg_record.json}; a fresh-rollup
///      bootstrap additionally reads close_lifecycle.json for its genesis root. Prints deployed
///      addresses.
